...
void main() {
  ...
  test('expect subscription correctly parses user ID', () {
    ...
    expect(subscriptionChanges.to.userId, 'c1b395fc-3b17-4c18-aaa6-195cd3461311');
  });

  test('expect subscription correctly parses push token', () {
    expect(subscriptionChanges.to.pushToken, '07afbb0b4cb6e7ae5e81efc7fd5d35267ea9a4f12120045aebe29945e52ea30e');
    expect(subscriptionChanges.to.pushToken, subscriptionChanges.from.pushToken);
  });

  test ('expect subscription correctly parses `subscribed`', () {
    expect(subscriptionChanges.to.subscribed, !subscriptionChanges.from.subscribed);
  });
